...
public class VentanaPar extends javax.swing.JFrame {
    ...
    public void personalizar_JFrame() {
        ...
        this.setIconImage(Toolkit.getDefaultToolkit().createImage(VentanaPar.class.getResource("mac.jpg")));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaPar().setVisible(true);
            }
        });
    }
