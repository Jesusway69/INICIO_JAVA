 ...
 * @author RYZEN
 */
public class VentanaListaAlumno extends javax.swing.JFrame {

    DefaultListModel dlmP = new DefaultListModel();
    DefaultListModel dlmI = new DefaultListModel();
    public VentanaListaAlumno() {
        initComponents();
                lstMenores.setModel(dlmP);
        lstMayores.setModel(dlmI);
    }
    ...
    private void initComponents() {
        ...
        lstMenores = new javax.swing.JList<>();
        jScrollPane2 = new javax.swing.JScrollPane();
        lstMayores = new javax.swing.JList<>();
        cmdEjecutar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        lstMenores.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lstMenores);

        lstMayores.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(lstMayores);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaListaAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaListaAlumno().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> lstMayores;
    private javax.swing.JList<String> lstMenores;
