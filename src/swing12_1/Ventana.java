...
public class Ventana extends javax.swing.JFrame {
    ...
    // BASE DE DATOS
    static String nra = "data/obreros.ser";
    ...
    public void cargarArrayList() {
        obreros_al = Controlador.leerObreroSerial(nra);
    }
    ...
    private void initComponents() {
        ...
        cmdActualizarSerial = new javax.swing.JButton();
        ...
        cmdActualizarSerial.setText("ACTUALIZAR SERIAL");
        cmdActualizarSerial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdActualizarSerialActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cmdActualizarSerial, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmdActualizarSerial))
                .addGap(30, 30, 30))
        );
    ...
    private void cmdActualizarSerialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdActualizarSerialActionPerformed
        ...
        for (Obrero obrero : obreros_al) {
            if (Controlador.escribirObreroSerial(nra, obrero)) {
                System.out.println("OK");
            } else {
                System.out.println("ERROR");
            }
        }
    }//GEN-LAST:event_cmdActualizarSerialActionPerformed
    ...
    private javax.swing.JButton cmdActualizarSerial;
