...
public class Ventana1 extends javax.swing.JFrame {
    ...
    private void cargarDatosTable() {
        limpiarTable();
        List<Cliente> clientes_al = Controlador.getArrayListCliente();
        if (clientes_al != null) {
            ...
            JOptionPane.showMessageDialog(this, "ERROR LISTA CLIENTE VACIA", "INFORMACION", JOptionPane.INFORMATION_MESSAGE);
        }
    }
